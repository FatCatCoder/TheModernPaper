    ...
    <div class="page-header min-vh-100">
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column mx-lg-0 mx-auto shadow border-0 border-radius-lg">
          ...
          <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center">
              <img src={process.env.PUBLIC_URL + `/pattern-lines.svg`} alt="pattern-lines" class="position-absolute opacity-4 start-0" />
              <div class="position-relative">
                <img class="max-width-500 w-100 position-relative z-index-2" src={process.env.PUBLIC_URL + `/chat.png`} />
              </div>
